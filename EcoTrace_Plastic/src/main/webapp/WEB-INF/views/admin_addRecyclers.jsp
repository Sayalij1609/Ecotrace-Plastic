...
<head>
    ...
    <title>Manage Recyclers - EcoTrack Admin</title>
            ...
            <table class="recyclers-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <% if ("pending".equalsIgnoreCase(recycler.getStatus())) { %>
                                <span class="status-badge status-pending">Pending</span>
                            <% } else if ("approved".equalsIgnoreCase(recycler.getStatus())) { %>
                        ...
                        <td>
                            <div class="action-btns">
                                <form action="ApproveRecycler" method="post" style="display:inline;">
                                    <input type="hidden" name="phone" value="<%= recycler.getPhone() %>" />
                                    <button class="action-btn btn-approve" type="submit">
                                        <i class="fas fa-check-circle"></i> Approve
                                    </button>
                                </form>
                                <form action="RejectRecycler" method="post" style="display:inline;">
                                    <input type="hidden" name="phone" value="<%= recycler.getPhone() %>" />
                    ...
                    <tr>
                        <td colspan="8" style="text-align:center; padding:20px;">No recyclers found</td>
                    </tr>
                    <% } %>
                </tbody>
            </table>
